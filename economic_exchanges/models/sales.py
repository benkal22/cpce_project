...
class Sale(models.Model):
    ...
    producer = models.ForeignKey(Producer, on_delete=models.CASCADE, related_name='producer_sale')
    ...
    product = models.ForeignKey(Product, on_delete=models.CASCADE, related_name='secteur_activite')
