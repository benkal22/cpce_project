...
class ProducerRegistrationForm(forms.ModelForm):
    ...
    class Meta:
        model = Producer
        fields = ('company_name', 'manager_name', 'product', 'province', 'address', 'tax_code', 
                  'nrc', 'nat_id', 'email', 'phone_number','username', 'password', 'confirm_password')
        labels = { 'company_name': "Nom de l'entreprise*", 'manager_name': "Nom du propriétaire*", 'product_id': "Type de produits/services*", 'address': "Adresse de l'entreprise*", 
                  'tax_code': "Numéro d'impôt de l'entreprise", 'nrc': "Code NRC de l'entreprise", 
                  'nat_id': "Identité Nationale de l'entreprise", 'email': "Votre email*", 'phone_number': "Votre numéro de téléphone*", 
                  'province': "Province/Ville de votre entreprice*"}
